...
const greeting = `<section class="greeting central--blur">
    ...
    <button class="greeting__top top" type="button" disabled>
...
const showRules = template.querySelector(`.greeting__continue`);

showRules.addEventListener(`click`, () => {
  showTemplate(`#main`, rules);
});
